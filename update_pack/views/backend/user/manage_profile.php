    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                    ...
                    <form action="<?php echo site_url('user/manage_profile/update_profile_info/'.$user_info['id']); ?>" method="post" enctype="multipart/form-data">
...
<div class="row">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo site_url('user/manage_profile/change_password/'.$user_info['id']); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-2">
