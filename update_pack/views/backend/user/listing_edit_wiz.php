  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?php echo site_url('user/listings/edit/'.$listing_id); ?>" method="post" role="form" class="form-horizontal form-groups-bordered listing_edit_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-md-10">
                        ...
                        <select class="form-control select2" data-toggle="select2" name="is_featured" id = "featured_type" <?php if($featured_type == 0) echo 'disabled'; ?> required >
                          ...
                          <option value="1" <?php if($featured_type == 1 && $listing_details['is_featured'] == 1) echo 'selected'; ?>><?php echo get_phrase('featured'); ?></option>
                          <option value="0" <?php if($featured_type == 0 || ($featured_type == 1 && $listing_details['is_featured'] == 0) ) echo 'selected'; ?>><?php echo get_phrase('none_featured'); ?></option>
                        </select>
                      </div>
                    </div>
