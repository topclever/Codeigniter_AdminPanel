          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title mb-0"><?php echo get_phrase('hotel_room_specification'); ?>
                <?php if ($key > 0 ): ?>
                  <button type="button" class="btn btn-outline-danger btn-sm btn-rounded alignToTitle" name="button" id = "<?php echo $hotel_room['id']; ?>" onclick="removeHotelRoomSpecification(this)"><?php echo get_phrase('remove_this_room'); ?></button>
                <?php endif; ?>
              </h5>
                    ...
                    <div class="wrapper-image-preview">
                      <div class="box">
                        ...
                        <div class="upload-options">
                          <label for="room-image-1" class="btn"> <i class="mdi mdi-camera"></i> <?php echo get_phrase('upload_room_image'); ?> <small>(800 X 533)</small>  </label>
  ...
  <div class="hotel_room_specification_div">
    <div class="col-xl-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title mb-0"><?php echo get_phrase('hotel_room_specification'); ?>
            <button type="button" class="btn btn-outline-danger btn-sm btn-rounded alignToTitle" name="button" onclick="removeHotelRoomSpecification(this)"><?php echo get_phrase('remove_this_room'); ?></button>
          </h5>
          <div class="collapse pt-3 show">
            <div class="row">
              <div class="col-xl-8">
