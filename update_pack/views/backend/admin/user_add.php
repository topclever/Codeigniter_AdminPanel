        ...
        <div class="card">
            <div class="card-body">
              <div class="col-lg-12">
                ...
                <form action="<?php echo site_url('admin/users/add'); ?>" method="post" role="form" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="facebook" placeholder="<?php echo get_phrase('write_down_facebook_url') ?>" aria-describedby="facebook">
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="twitter" placeholder="<?php echo get_phrase('write_down_twitter_url') ?>" aria-describedby="twitter">
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="linkedin" placeholder="<?php echo get_phrase('write_down_linkedin_url') ?>" aria-describedby="linkedin">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="user_image"name="user_image" accept="image/*">
                                <label class="custom-file-label" for="user_image"><?php echo get_phrase('user_image'); ?></label>
                            </div>
                        </div>
                    </div>
