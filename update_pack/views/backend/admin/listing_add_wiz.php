	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<form action="<?php echo site_url('admin/listings/add'); ?>" method="post" role="form" class="form-horizontal form-groups-bordered listing_add_form" enctype="multipart/form-data">
								...
								<div class="row justify-content-center">
									<div class="col-lg-8">
										<!-- <div class="form-group row mb-3">
											<label class="col-md-2 form-label" for="package"><?php echo get_phrase('package'); ?></label>
											<div class="col-md-10">
												<select name="package" class="form-control select2" data-toggle="select2" required>
