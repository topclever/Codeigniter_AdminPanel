	...
	<!-- <div class="wrapper">
		<span class="magnific-gallery">
			<?php foreach (json_decode($listing_details['photos']) as $key => $photo): ?>
				<a href="<?php echo base_url('uploads/listing_images/'.$photo); ?>" class="btn_photos" title="<?php echo $listing_details['name']; ?>" data-effect="mfp-zoom-in">
					<?php echo $key == 0 ? get_phrase('view_photos') : get_phrase('view_photos'); ?>
				</a>
			<?php endforeach; ?>
		</span>
	</div> -->
		...
		<div class="col-lg-8">
			<section id="description">
				<div class="detail_title_1">
					<h1><?php echo $listing_details['name']; ?></h1>
				...
				<div class="add_bottom_15">
					...
					<span class="loc_open mr-2">
						<a href="<?php echo site_url('home/filter_listings?category='.slugify($category_name)); ?>" 
							style="color: #32a067;">
				...
				<div class="row add_bottom_30">
					<?php foreach (json_decode($listing_details['amenities']) as $key => $amenity): ?>
						<div class="col-md-4">
							<ul class="bullets">
								<li><?php echo $this->frontend_model->get_amenity($amenity, 'name')->row()->name; ?></li>
							</ul>
						</div>
					<?php endforeach; ?>
				</div>
