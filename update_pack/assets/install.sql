...
--
-- Host: localhost
-- Generation Time: Jul 01, 2019 at 11:51 AM
...
CREATE TABLE `country` (
  ...
  `dial_code` varchar(5) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `currency_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `currency_symbol` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `currency_code` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `food_menu` (
  ...
  `items` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
CREATE TABLE `hotel_room_specification` (
  ...
  `description` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `price` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `amenities` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `photo` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `listing` (
  ...
  `amenities` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `photos` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `video_url` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `social` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `user_id` int(11) DEFAULT NULL,
  ...
  `listing_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `listing_thumbnail` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `listing_cover` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `seo_meta_tags` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `date_added` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `package_purchased_history` (
  ...
  `amount_paid` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_details` (
  ...
  `listing_id` int(11) DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `variant` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `price` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `photo` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `reported_listing` (
  ...
  `report` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
CREATE TABLE `review` (
  ...
  `review_comment` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
CREATE TABLE `review_wise_quality` (
  ...
  `quality` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'website_title', 'ATLAS Directory Listing CMS'),
...
CREATE TABLE `time_configuration` (
  `id` int(11) UNSIGNED NOT NULL,
  `listing_id` int(11) DEFAULT NULL,
  `saturday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sunday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `monday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `tuesday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `wednesday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `thursday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `friday` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `user` (
  ...
  `website` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `social` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `wishlists` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
