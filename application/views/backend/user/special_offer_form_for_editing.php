          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title mb-0"><?php echo get_phrase('special_offers'); ?>
                <?php if ($key > 0 ): ?>
                  <button type="button" class="btn btn-outline-danger btn-sm btn-rounded alignToTitle" name="button" id = "<?php echo $product['id']; ?>" onclick="removeSpecialOffer(this)"><?php echo get_phrase('remove_this_product'); ?></button>
                <?php endif; ?>
              </h5>
