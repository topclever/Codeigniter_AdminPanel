				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="add" style="padding: 30px">
						<div class="row">
                          ...
                          <input type="text" id="phrase" name="phrase" class="form-control" placeholder="Eg. Contamination" required>
                      </div>
					...
					<div class="tab-pane" id="add_lang" style="padding: 30px">
						<div class="row">
                          ...
                          <input type="text" id="language" name="language" class="form-control" placeholder="Eg. Bengali" required>
                      </div>
											<button type="submit" class="btn btn-primary" name="button"><?php echo get_phrase('save'); ?></button>
										</form>
									</div>
