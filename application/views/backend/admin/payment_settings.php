...
<div class="row ">
  <div class="col-xl-12">
    <div class="card">
      <div class="card-body">
        <h4 class="page-title"> <i class="mdi mdi-account-circle title_icon"></i> <?php echo get_phrase('setup_payment_informations'); ?></h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
</div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <form class="" action="<?php echo site_url('admin/payment_settings/system_currency_settings'); ?>" method="post" enctype="multipart/form-data">
